...
namespace mxslc
{
    ...
    public:
        ...
        Token(const TokenType type, std::string lexeme) : type_{type}, lexeme_(std::move(lexeme)) { }
        ...
        bool operator==(const std::string& s) const { return lexeme_ == s; }
        ...
        bool operator!=(const std::string& s) const { return not (*this == s); }
