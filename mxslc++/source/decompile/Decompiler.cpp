...
string mxslc::Decompiler::decompile_node(const string& node_name, const bool with_dependencies)
{
    return decompile_node(document_->getNode(node_name), with_dependencies);
}

string mxslc::Decompiler::decompile_node(const mx::NodePtr& node, const bool with_dependencies)
{
    global_code_ = "";
    decompiled_nodes_.clear();
...
string mxslc::Decompiler::decompile_node_def(const string& node_def_name, const bool with_dependencies)
{
    return decompile_node_def(document_->getNodeDef(node_def_name), with_dependencies);
}

string mxslc::Decompiler::decompile_node_def(const mx::NodeDefPtr& node_def, const bool with_dependencies)
{
    global_code_ = "";
    decompiled_nodes_.clear();
...
string mxslc::Decompiler::decompile_node_graph(const string& node_graph_name, const bool with_dependencies)
{
    return decompile_node_graph(document_->getNodeGraph(node_graph_name), with_dependencies);
}

string mxslc::Decompiler::decompile_node_graph(const mx::NodeGraphPtr& node_graph, const bool with_dependencies)
{
    global_code_ = "";
    decompiled_nodes_.clear();
...
string mxslc::Decompiler::node_to_variable_definition(const string& node_name)
{
...
string mxslc::Decompiler::node_def_to_function_definition(const mx::NodeDefPtr& node_def)
{
    for (const mx::NodeGraphPtr& node_graph : document_->getNodeGraphs())
    {
...
string mxslc::Decompiler::node_graph_to_function_definition(const string& node_graph_name)
{
    return node_graph_to_function_definition(document_->getNodeGraph(node_graph_name));
}

string mxslc::Decompiler::node_graph_to_function_definition(const mx::NodeGraphPtr& node_graph)
{
...
string mxslc::Decompiler::outputs_to_data_type(const vector<mx::OutputPtr>& outputs)
{
    if (outputs.size() == 1)
    {
...
string mxslc::Decompiler::port_to_expression(const mx::PortElementPtr& port)
{
    if (port->hasValue())
...
string mxslc::Decompiler::outputs_to_expression(const vector<mx::OutputPtr>& outputs)
{
    if (outputs.size() == 1)
...
string mxslc::Decompiler::input_to_argument(const mx::InputPtr& input)
{
    return input->getName() + " = " + port_to_expression(input);
}

string mxslc::Decompiler::inputs_to_arguments(const vector<mx::InputPtr>& inputs)
{
    string result;
...
string mxslc::Decompiler::input_to_parameter(const mx::InputPtr& input)
{
...
string mxslc::Decompiler::inputs_to_parameters(const vector<mx::InputPtr>& inputs)
{
    string result;
    for (const mx::InputPtr& input : inputs)
...
string mxslc::Decompiler::get_node_data_type(const mx::NodePtr& node)
{
...
string mxslc::Decompiler::get_node_def_data_type(const mx::NodeDefPtr& node_def)
{
...
string mxslc::Decompiler::get_node_graph_signature(const mx::NodeGraphPtr& node_graph)
{
...
string mxslc::Decompiler::get_node_graph_identifier(const mx::NodeGraphPtr& node_graph)
{
    return node_graph_name_to_identifier(node_graph->getName());
}

string mxslc::Decompiler::get_node_graph_return_expression(const mx::NodeGraphPtr& node_graph)
{
    if (node_graph->hasNodeDefString())
    {
        const mx::NodeDefPtr node_def = node_graph->getNodeDef();
