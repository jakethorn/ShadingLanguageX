...
{
public:
    static ExprPtr function_call(string func_name);
    ...
    static ExprPtr method_call(VarPtr instance, string func_name);
    ...
    static VarPtr invoke_function(const TypePtr& target_type, string func_name, ArgumentList args);
    static VarPtr invoke_function(const vector<TypePtr>& target_types, string func_name);

    static VarPtr invoke_method(const vector<TypePtr>& target_types, VarPtr instance, string func_name);

    static VarPtr invoke_constructor(string ctor_name, ArgumentList args);
    static VarPtr invoke_constructor(const TypePtr& target_type, string ctor_name, ArgumentList args);
